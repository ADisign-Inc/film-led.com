...
export const caseData: Case[] = [
  {
    ...
    description:
      "高級ブランド店やショッピングモールでは、ガラスのウィンドウに透明フィルム型LEDビジョンを設置することで、商品展示と連動したインパクトある映像演出や広告表示が可能になります。\nディスプレイ映像とリアルな商品が一体化して見える演出により、視覚的なインパクトを最大化し、より洗練されたプランドイメージや購買意欲を高める効果が期待できます。",
