        ...
        <main className="flex-1">
          ...
          <section className="py-10 md:py-20 mb-10">
            ...
            <div className="mb-24 md:mb-32">
              <div className="flex gap-5 md:gap-10 mb-5 items-end relative">
                <div className="w-full md:w-2/3 relative aspect-[3/4] md:aspect-video flex items-start">
                  <picture>
                    <source
                      media="(max-width: 767px)"
                      srcSet="/images/about/01_sp.jpg"
                    />
                    <img
                      src="/images/about/01.jpg"
                      alt=""
                ...
                <div className="w-auto">
                  <div className="flex items-baseline mb-8 md:mb-14">
                    <p className="text-yellow-300 text-4xl md:text-6xl font-bold leading-none">
                      販売
                    </p>
                  ...
                  <p className="md:pr-40 mb-10 md:mb-14">
                ...
                <div className="absolute top-16 right-0 md:-bottom-12 left-auto md:w-2/3 h-full bg-white/20 -z-10" />
              </div>
            </div>
          ...
          <section className="container max-w-6xl py-10 md:py-20 mb-10">
            ...
            <div className="grid gap-12 md:gap-8 grid-cols-1 md:grid-cols-3 pt-14 mb-10">
              <div className="relative">
                <p className="absolute -top-7 left-0 text-yellow-300 text-4xl font-bold">
                  Step 1
                </p>
            ...
            <div className="relative w-full max-w-5xl h-16 mx-auto text-white text-center flex items-center justify-center font-bold mb-3">
              ...
              ></div>
              <span className="z-10 text-xl md:text-2xl tracking-wider">
                ご注文から最短20日で導入完了！
              </span>
            </div>

            <p className="text-center mb-24 md:mb-32">
